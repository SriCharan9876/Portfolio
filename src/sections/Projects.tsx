                    ...
                    {selectedProject && (
                        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                            ...
                            <motion.div
                                ...
                                className="relative w-full max-w-2xl bg-white rounded-3xl overflow-hidden shadow-2xl z-10 max-h-[90vh] border-2 border-black flex flex-col"
                            >
                                <button
                                    onClick={() => setSelectedProject(null)}
                                    className="absolute top-4 right-4 p-2 bg-slate-900/50 hover:bg-slate-900/80 text-white rounded-full transition-all duration-200 z-30 shadow-lg hover:scale-105 active:scale-95 border border-white/20 backdrop-blur-sm"
                                >
                                    <X size={20} />
                                </button>
                                ...
                                <AnimatePresence>
                                    {showScrollArrow && (
                                        <motion.button
                                            ...
                                            className="absolute bottom-6 left-1/2 -translate-x-1/2 p-3 bg-slate-900 text-white rounded-full shadow-xl hover:bg-slate-800 transition-all duration-200 z-30 hover:scale-110 active:scale-95 flex items-center justify-center border border-white/10"
                                        >
